...
export default function ValidationFile({ dossierId }) {
    ...
    <div className="position-relative">
        ...
        >
                            ...
                            <table className="table table-sm table-borderless mb-0">
                                <tbody>
                                    <tr style={{ borderBottom: "1px solid #e9ecef" }}>
                                        <td style={{ width: "40%", fontWeight: "600", color: "#495057", padding: "8px" }}>
                                            <i className="fas fa-hashtag me-2 text-teal"></i>
                                            Num Compte
                                        </td>
                                        <td style={{ padding: "8px", fontWeight: "500", color: "#2c3e50" }}>
                                            {fetchData.NumCompte}
                                        </td>
                                    </tr>
                                    <tr style={{ borderBottom: "1px solid #e9ecef" }}>
                                        <td style={{ padding: "8px", fontWeight: "600", color: "#495057" }}>
                                    ...
                                    <tr style={{ borderBottom: "1px solid #e9ecef" }}>
                                        ...
                                        <td style={{ padding: "8px", fontWeight: "500", color: "#2c3e50" }}>
                                            <strong className="text-success">
                                                {new Intl.NumberFormat("fr-FR").format(fetchData.montant_demande)}{" "}
                                    ...
                                    <tr>
                                        ...
                                        <td style={{ padding: "8px", fontWeight: "500", color: "#2c3e50" }}>
                                            {new Date(fetchData.date_demande).toLocaleDateString("fr-FR")}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div className="card border-0 shadow-sm rounded-3 h-100">
                        ...
                        <div className="card-body p-0">
                            <table className="table table-sm table-borderless mb-0">
                                <tbody>
                                    <tr style={{ borderBottom: "1px solid #e9ecef" }}>
                                        <td style={{ width: "40%", padding: "8px", fontWeight: "600", color: "#495057" }}>
                                    ...
                                    <tr style={{ borderBottom: "1px solid #e9ecef" }}>
                                        ...
                                        <td style={{ padding: "8px", fontWeight: "500", color: "#2c3e50" }}>
                                            <strong className="text-info">{fetchData.taux_interet}%</strong>
                                        </td>
                                    </tr>
                                    <tr style={{ borderBottom: "1px solid #e9ecef" }}>
                                        <td style={{ padding: "8px", fontWeight: "600", color: "#495057" }}>
                            ...
                            <table className="table table-sm table-borderless mb-0">
                                <tbody>
                                    ...
                                    <tr style={{ borderBottom: "1px solid #e9ecef" }}>
                                        ...
                                        <td style={{ padding: "8px", fontWeight: "500", color: "#2c3e50" }}>
                                            {new Intl.NumberFormat("fr-FR").format(fetchData.valeur_comptable)}{" "}
                                            {fetchData.monnaie == "CDF" ? "FC " : " USD"}
                                        </td>
                                    </tr>
                                    <tr style={{ borderBottom: "1px solid #e9ecef" }}>
                                    ...
                                    <tr style={{ borderBottom: "1px solid #e9ecef" }}>
                                        ...
                                        <td style={{ padding: "8px", fontWeight: "500", color: "#2c3e50" }}>
                                            <strong className="text-success">
                                                {new Intl.NumberFormat("fr-FR").format(fetchData.valeur_garantie)}{" "}
                                                {fetchData.monnaie == "CDF" ? "FC " : " USD"}
                                            </strong>
                                        </td>
                                    </tr>
                                    <tr style={{ borderBottom: "1px solid #e9ecef" }}>
                                        ...
                                        <td style={{ padding: "8px", fontWeight: "500", color: "#2c3e50" }}>
                                            {fetchData.date_sortie_titre || "Non renseigné"}
                                        </td>
                                    </tr>
                                    <tr style={{ borderBottom: "1px solid #e9ecef" }}>
                                        <td style={{ padding: "8px", fontWeight: "600", color: "#495057" }}>
                                        ...
                                        <td style={{ padding: "8px", fontWeight: "500", color: "#2c3e50" }}>
                                            {fetchData.date_expiration_titre || "Non renseigné"}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style={{ padding: "8px", fontWeight: "600", color: "#495057" }}>
            ...
            {/* Section signatures avec montants proposés - MODIFIÉE */}
            <div className="mt-0">
                    ...
                    <div className="card-body">
                        <div className="row g-3">
                            ...
                            <div className="col-md-3">
                                <div
                                    className="text-center p-4 border rounded-3 bg-light"
                                    style={{
                                        minHeight: "180px",
                                        display: "flex",
                                ...
                                >
                                    <div>
                                        ...
                                        <p className="mb-0 fw-semibold">Agent crédit</p>
                                    ...
                                    {propositions && propositions.find((p) => p.nom === fetchData.recouvreur) && (
                                        <div className="mt-2 p-1 bg-success bg-opacity-10 rounded">
                                            <small className="text-success fw-semibold">
                                                <i className="fas fa-hand-holding-usd me-1"></i>
                                                {new Intl.NumberFormat("fr-FR").format(
                                                    propositions.find((p) => p.nom === fetchData.recouvreur).montant,
                                                )}{" "}
                                                {fetchData.monnaie == "CDF" ? "FC " : " USD"}
                                            </small>
                                        </div>
                            ...
                            <div className="col-md-3">
                                ...
                                >
                                    <div>
                                        ...
                                        <p className="mb-0 fw-semibold">Superviseur</p>
                                        {/* <small className="text-muted">Signature</small> */}
                                    </div>
                                    <div
                                        style={{
                                    ...
                                    {propositions && propositions.find((p) => p.nom === "Superviseur") && (
                                        <div className="mt-2 p-1 bg-success bg-opacity-10 rounded">
                                            <small className="text-success fw-semibold">
                                                <i className="fas fa-hand-holding-usd me-1"></i>
                                                {new Intl.NumberFormat("fr-FR").format(
                                                    propositions.find((p) => p.nom === "Superviseur").montant,
                                                )}{" "}
                                                {fetchData.monnaie == "CDF" ? "FC " : " USD"}
                                            </small>
                                        </div>
                            ...
                            <div className="col-md-3">
                                ...
                                >
                                    <div>
                                        ...
                                        <p className="mb-0 fw-semibold">CTC</p>
                                        {/* <small className="text-muted">Signature</small> */}
                                    </div>
                                    <div
                                        style={{
                                    ...
                                    {propositions && propositions.find((p) => p.nom === "CTC") && (
                                        <div className="mt-2 p-1 bg-success bg-opacity-10 rounded">
                                            <small className="text-success fw-semibold">
                                                <i className="fas fa-hand-holding-usd me-1"></i>
                                                {new Intl.NumberFormat("fr-FR").format(
                                                    propositions.find((p) => p.nom === "CTC").montant,
                                                )}{" "}
                                                {fetchData.monnaie == "CDF" ? "FC " : " USD"}
                                            </small>
                                        </div>
                            ...
                            <div className="col-md-3">
                                ...
                                >
                                    <div>
                                        ...
                                        <p className="mb-0 fw-semibold">CC</p>
                                        {/* <small className="text-muted">Signature</small> */}
                                    </div>
                                    <div
                                        style={{
                                    ...
                                    {propositions && propositions.find((p) => p.nom === "CC") && (
                                        <div className="mt-2 p-1 bg-success bg-opacity-10 rounded">
                                            <small className="text-success fw-semibold">
                                                <i className="fas fa-hand-holding-usd me-1"></i>
                                                {new Intl.NumberFormat("fr-FR").format(
                                                    propositions.find((p) => p.nom === "CC").montant,
                                                )}{" "}
                                                {fetchData.monnaie == "CDF" ? "FC " : " USD"}
                                            </small>
                                        </div>
        ...
        >
            ...
            <div style={{ marginBottom: "20px" }}>
                ...
                <p style={{ fontSize: "14px", color: "#6b7280", margin: 0 }}>
                    Document officiel pour la collecte des signatures
                </p>
            </div>
            ...
            >
                <i className="fas fa-hand-point-right" style={{ color: "#eab308", fontSize: "24px" }}></i>
                <div>
                    <strong style={{ color: "#854d0e", fontSize: "13px", display: "block", marginBottom: "4px" }}>
                        Important
                    </strong>
                    <p style={{ color: "#854d0e", fontSize: "12px", margin: 0, lineHeight: "1.5" }}>
                        Ce document doit être signé par toutes les parties concernées avant validation finale.
                    </p>
                </div>
            </div>
            ...
            <div style={{ marginBottom: "24px" }}>
                <button
                    ...
                    onMouseEnter={(e) => {
                        ...
                        e.currentTarget.style.boxShadow = "0 12px 28px rgba(32, 201, 151, 0.45)";
                        e.currentTarget.style.background = "linear-gradient(135deg, #059669 0%, #047857 100%)";
                    }}
                    onMouseLeave={(e) => {
                        e.currentTarget.style.transform = "translateY(0)";
                        e.currentTarget.style.boxShadow = "0 6px 20px rgba(32, 201, 151, 0.35)";
                        e.currentTarget.style.background = "linear-gradient(135deg, #20c997 0%, #059669 100%)";
                    }}
                >
