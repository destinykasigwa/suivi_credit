                                                                ...
                                                                >
                                                                    <div className="card border-0 shadow-sm rounded-3 overflow-hidden">
                                                                        <div className="position-relative">
                                                                            ...
                                                                            <div
                                                                                className="position-absolute bottom-0 start-0 end-0 bg-dark bg-opacity-75 text-white p-1 text-center"
                                                                                style={{
                                                                                    fontSize:
                                                                                        "10px",
                                                                                }}
                                                    ...
                                                    >
                                                        <div className="card border-0 shadow-sm rounded-3 overflow-hidden">
                                                            <div className="card-body p-3 text-center">
                                                                ...
                                                                <h6
                                                                    className="fw-semibold small mb-2 text-truncate"
                                                                    title={getFileName(
                                                                        pdf.path,
                                                                    )}
                                                                >
                                    ...
                                    (!dossier.pdfs ||
                                        ...
                                        <div className="text-center py-5">
                                            ...
                                            <p className="text-muted mb-0">
                                                Aucun titre disponible pour ce
                                                dossier
                                            </p>
                                            <small className="text-muted">
                                                Aucune image ou document PDF
                                                trouvé
                                            </small>
                                        </div>
                                    )}
