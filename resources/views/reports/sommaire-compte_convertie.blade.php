...
<body>
    ...
    <div class="container">
        ...
        <h1 style="text-align: center">
            {{ isset($fetchData[0]['solde_consolide_usd_to_cdf']) && $fetchData[0]['solde_consolide_usd_to_cdf']
                ? 'Sommaire de compte converti en CDF'
                : (isset($fetchData[0]['solde_consolide_cdf_to_usd']) && $fetchData[0]['solde_consolide_cdf_to_usd']
                    ? 'Sommaire de compte converti en USD'
                    : 'Sommaire de compte converti') }}
            du {{ $date_debut_balance }} au {{ $date_fin_balance }}
        </h1>
            ...
            @foreach ($fetchData as $data)
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ isset($data['solde_consolide_usd_to_cdf']) && $data['solde_consolide_usd_to_cdf']
                                ? number_format($data['solde_consolide_usd_to_cdf'], 2)
                                : (isset($data['solde_consolide_cdf_to_usd']) && $data['solde_consolide_cdf_to_usd']
                                    ? number_format($data['solde_consolide_cdf_to_usd'], 2)
                                    : '0.00') }}
                        </td>
                        </td>
                    </tr>
