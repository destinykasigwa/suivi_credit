...
<head>
    ...
    <title>COOPEC AKIBA YETU - Communication officielle</title>
    <style>
...
<body>
    <div class="email-container">
        ...
        <div class="header">
            ...
            <h1>AKIBA YETU</h1>
            <p>COOPERATIVE D'EPARGNE ET DE CREDIT</p>
        </div>
        ...
        <div class="content">
            ...
            <div class="message-card">
                <!-- {{-- <p>Bonjour {{ $user->name }}, votre rôle est {{ $user->Role }}</p> --}} -->
                 <p><strong>{!! nl2br(e($userName)) !!}</strong></p> <br> <br>
            ...
            <div class="info-section">
                <div class="address-block">
                    ...
                    Rue N°13 Avenue Mont-Goma N°23 / Rue NZUMUKA James; 
                    <br> Commune de GOMA Nord-Kivu, RDCongo
                   
                </div>

                <div class="contacts-block">
                    <div class="info-title contacts">Contacts</div>
                    🌐 Site web : <a href="https://www.coopecakibayetu.org">www.ihdemunis.org</a><br>
                    📞 Tél : <a href="tel:+243 970 237 272">+243 970 237 272</a><br>
                    ✉️ Courriel : <a href="mailto:contact@coopecakibayetu.org">contact@coopecakibayetu.org</a>
                </div>
            </div>
        ...
        <div class="footer-note">
            <p>📧 Ce message vous a été envoyé automatiquement depuis l'outil de suivi de crédit <strong>CrediX</strong>.<br>
            Merci de ne pas répondre à cet email.</p>
            <p style="margin-top: 8px; font-size: 11px;">&copy; {{ date('Y') }} COOPEC AKIBA YETU - Tous droits réservés.</p>
        </div>
    </div>
</body>
